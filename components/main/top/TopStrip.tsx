...
export default function TopStrip() {
    return (
        <div className="w-full hidden md:block border-b bg-gradient-to-r from-slate-50 to-white top-shadow text-[15px]">
            <Container className="h-11 flex items-center justify-between text-slate-800">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a
                        className="inline-flex items-center gap-2 px-2 py-1 rounded-lg hover:bg-slate-100/80 hover:text-slate-900 transition-all duration-200"
                    ...
                    {/* Nút giỏ hàng xanh nổi bật với enhanced styling */}
                    <a
                        href="#"
                        className="ml-2 inline-flex items-center gap-2 h-9 px-4 rounded-full bg-gradient-to-r from-emerald-600 to-emerald-700 text-white shadow-md hover:shadow-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-200 transform hover:scale-105"
                    >
                        <ShoppingCart size={15} />
                        <span className="font-semibold">Giỏ hàng</span>
                        <span className="ml-1 inline-flex items-center justify-center w-5 h-5 text-[10px] font-bold rounded-full bg-white/90 text-emerald-700">
                            0
                        </span>
                    </a>
                </div>
