  ...
  "Tất cả SP": [
    ...
    },
    {
      ...
      items: [
        { label: "Đèn chùm" },
        { label: "Đèn thả" },
        { label: "Đèn cây, Đèn sàn" },
        { label: "Đèn bàn" },
        { label: "Đèn mâm ốp trần" },
      ],
    },
    {
      title: "Đèn tường",
      items: [
        ...
        { label: "Đèn gương" },
        { label: "Đèn tranh" },
        { label: "Đèn âm tường - chân cầu thang" },
        { label: "Đèn tường ngoài trời" },
      ],
    },
    {
      title: "Đèn ngoài trời",
      items: [
        { label: "Đèn Pha LED" },
        { label: "Đèn sân vườn" },
        { label: "Đèn LED âm đất" },
        { label: "Đèn LED âm nước" },
        { label: "Đèn trụ cổng" },
        { label: "Đèn NLMT" },
      ],
    },
    {
      title: "Đèn led rọi ray",
      items: [
        { label: "Đèn rọi nam châm" },
        { label: "Thanh ray nam châm" },
        { label: "Nguồn ray nam châm" },
        { label: "Phụ kiện ray nam châm" },
        { label: "Đèn rọi ray T2/T3" },
        { label: "Thanh ray đèn LED" },
      ],
    },
    {
      title: "Đèn tuýp LED",
      items: [{ label: "Đèn tuýp LED bán nguyệt" }, { label: "Đèn tuýp LED T5" }, { label: "Đèn tuýp LED T8" }],
    },
    {
      title: "Bóng đèn LED",
      items: [
        { label: "Bóng đèn LED tròn" },
        { label: "Bóng đèn LED trụ" },
        { label: "Bóng đèn LED nến" },
        { label: "Bóng LED chân cắm" },
        { label: "Bóng LED filament" },
      ],
    },
    {
      title: "Đèn LED dây",
      items: [{ label: "Đèn LED dây 220V" }, { label: "Đèn LED dây dán 12V-24V" }, { label: "Phụ kiện đèn LED dây" }],
    },
    {
      title: "Đèn chuyên dụng",
      items: [
        { label: "Đèn đường" },
        { label: "Đèn xưởng" },
        { label: "Đèn Exit" },
        { label: "Đèn sự cố" },
        { label: "Đèn chống ẩm" },
        { label: "Đèn chống cháy nổ" },
      ],
    },
    {
      title: "Nguồn - Linh kiện - Máng đèn",
      items: [{ label: "Máng đèn" }, { label: "Thanh nhôm đèn LED" }, { label: "Driver - Nguồn LED" }],
    },
    {
      title: "Quạt trần",
      items: [
        { label: "Quạt trần 5 cánh" },
        { label: "Quạt trần 3 cánh" },
        { label: "Quạt trần giấu cánh / cánh cụp xòe" },
      ],
    },
...
export default function HeaderWithCategories() {
  ...
  return (
    ...
    >
      {/* top bar */}
      <div className="h-[72px] container-x grid items-center gap-3" style={{ gridTemplateColumns: "auto 1fr auto" }}>
          ...
          <div className="grid grid-cols-[1fr_220px] gap-0">
              ...
              {simpleItems.map((t, i) => (
                <li key={i} className="py-2">
                  ...
                  >
                    ...
                    <span className="opacity-0 translate-x-[-4px] text-emerald-600 group-hover:opacity-100 group-hover:translate-x-0 transition">
                      →
                    </span>
                  </Link>
                </li>
            ...
            <div className="p-3 ">
              <div className="relative aspect-square w-full rounded-xl ring-1 ring-emerald-600/15 shadow-md overflow-hidden">
                {simplePreview ? (
                  <Image
                    src={simplePreview || "/placeholder.svg"}
                    alt={active || "preview"}
                    fill
                    sizes="220px"
                ...
                <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between gap-2">
                  <span className="max-w-[70%] truncate text-[12px] font-semibold text-white/95 drop-shadow">
                    {active}
                  </span>
                  <Link
                    href="#"
