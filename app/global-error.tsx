        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50">
          <div className="text-center max-w-md mx-auto px-4">
            <div className="mb-8">
              ...
              <h1 className="text-2xl font-bold text-slate-900 mb-2">Lỗi hệ thống</h1>
              <p className="text-slate-600 mb-8">Đã xảy ra lỗi nghiêm trọng. Vui lòng thử lại hoặc liên hệ hỗ trợ.</p>
            </div>
