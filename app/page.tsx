  ...
  return (
    <main className="min-h-screen overflow-hidden">
      ...
      <ProductCarousel
        title="ĐÈN TRANG TRÍ"
        products={PRODUCTSLEDAMTRAN}
        tabs={["Đèn chùm", "Đèn chùm pha lê", "Đèn thả", "Đèn chùm hiện đại"]}
      />
      ...
      <ProjectsSection
        ...
        items={[
          {
            image: "/den-sai-gon/anh-cong-trinh/hinh-cong-trinh-1.jpg",
            title: "Cung cấp đèn LED cho biệt thự song lập Camelia Eco Garden Huế",
          },
          {
            image: "/den-sai-gon/anh-cong-trinh/hinh-cong-trinh-2.jpg",
            title: "Cung cấp đèn LED cho khách sạn Wyndham Hạ Long",
            href: "#",
          },
          {
            image: "/den-sai-gon/anh-cong-trinh/hinh-cong-trinh-3.jpg",
            title: "Cung cấp đèn LED hệ thống chiếu sáng showroom xe Mazda",
          },
          {
            image: "/den-sai-gon/anh-cong-trinh/hinh-cong-trinh-4.jpg",
